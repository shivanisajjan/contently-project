package com.stackroute.reccomendation.controller;
...
public class RecommendationController {
    public RecommendationController(UserService userService, BookService bookService) {
...
//
//    @GetMapping("users")
//    public Collection<User> getByName1() {return userService.getAll();}
