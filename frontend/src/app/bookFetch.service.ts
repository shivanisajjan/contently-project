...
export class BookFetchService {
  ...
  getGit(fileName: String): Observable<any> {  //made static for now
    console.log("get contents of file: ", fileName);
    return this.http.get<any>("https://api.github.com/repos/contently-books/" + "new" + "/contents/" + "newfile", this.httpOptions);
